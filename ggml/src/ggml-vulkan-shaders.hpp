...
extern unsigned char get_rows_iq4_nl_data[4212];
const uint64_t get_rows_iq4_nl_len = 4212;

extern unsigned char get_rows_iq4_nl_f32_data[4196];
const uint64_t get_rows_iq4_nl_f32_len = 4196;
